...
d3.csv("static/states_all_extended.csv", function(data) {
	...
	for (var i = 0; i < data.length; i++) {
	    list[i] = data[i].AVG_MATH_8_SCORE;
	}
	...
	//console.log(list.length);
	    ...
	    // Grab data value
	    var dataValue = data[i].AVG_MATH_8_SCOREVENUE;
      ...
      //console.log(splt);
		    ...
		    json.features[j].properties.AVG_MATH_8_SCOREVENUE = dataValue;
  	...
  	// Get data value
 		var value = d.properties.AVG_MATH_8_SCORE;
		console.log(value);
		if (value == 1) {
