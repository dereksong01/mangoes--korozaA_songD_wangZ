...
d3.csv("static/states_all_extended.csv", function(data) {
	...
	console.log(list.length);
      ...
      //console.log(splt);
		    ...
		    json.features[j].properties.ENROLL = dataValue;
  	...
  	// Get data value
		...
		else if (value < 1307022) {
		    return "rgb(0,255,255)"
		}
		else if (value < 2307022) {
		    return "rgb(30,144,255)"
		}
		else if (value < 3307022) {
		    return "rgb(100,149,237)"
		}
		else if (value < 4307022) {
		    return "rgb(127,255,212)"
		}
		else if (value < 5307022) {
		    return "rgb(70,130,180)"
		}
		else if (value < 6307022) {
